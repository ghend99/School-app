...
When updating the DOM with the information required I needed very specific information from the objects, and in order to access this data I use the keyword of the object I want to access paired with the value I want to access. This allows me to access specific values with ease.
