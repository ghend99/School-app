...
4. Another point to consider is that the variables seen inside the diagram are declared globally, meaning they belong to global scope. The reasons for this was that they needed to be accesed by
