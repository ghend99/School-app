...
1. This requires the student to be previosuly inputted into the "student" array.
2. Access the "send-message" modal through the sidebar.
3. Input the intended targets "full-name", then a subject, and then fill the textarea box with the message.
4. Once the message has been finshed, press the send button.
5. The message can be viewed from both the sender and recivers inbox. This is accessed through pressing the "view-inbox" button in the sidebar.
