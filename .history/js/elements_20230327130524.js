...
/////////////////// Login ///////////////////
const loginFullname = document.querySelector(".login-input-fullname");
const loginPin = document.querySelector(".login-input-pin");
const loginPinShow = document.querySelector(".login-input-pin");
