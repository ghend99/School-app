...
2. Students can be searched for through the
...
1.  Make a list of all features to implement prior to beginning development.
...
1. Login through localstorage.
2. Add/Search for specific students.
